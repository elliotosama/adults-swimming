...
$routes = [
    ...
    ['GET',  '/receipt/manage', fn() => $receipt->manage()],
    ...
    ['GET', '/receipt/view-modal', fn() => $receipt->viewModal()],
    ['GET', '/receipt/edit-modal', fn() => $receipt->editModal()],
    ['GET', '/receipt/logs-modal', fn() => $receipt->logsModal()],
